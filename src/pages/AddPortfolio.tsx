...
const AddPortfolio = () => {
  ...
  const [sections, setSections] = useState<{ section_type: string; image_file: File | null }[]>([]);
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button onClick={addSection} className="bg-blue-500 hover:bg-blue-600">
                ...
                {sections.map((section, index) => (
                  <div key={index} className="flex gap-4 mb-4">
                    ...
                    <div className="space-y-2 flex-1">
                      <Label htmlFor={`section_image_${index}`}>Image</Label>
                      <Input
                ...
                <Button onClick={handleSaveSections} className="bg-green-500 hover:bg-green-600">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button onClick={addClinic} className="bg-blue-500 hover:bg-blue-600">
                ...
                <Button onClick={handleSaveClinics} className="bg-green-500 hover:bg-green-600">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button onClick={addExpertise} className="bg-blue-500 hover:bg-blue-600">
                ...
                <Button onClick={handleSaveExpertise} className="bg-green-500 hover:bg-green-600">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button onClick={addReview} className="bg-blue-500 hover:bg-blue-600">
                ...
                <Button onClick={handleSaveReviews} className="bg-green-500 hover:bg-green-600">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <Button onClick={addVideo} className="bg-blue-500 hover:bg-blue-600">
                ...
                <Button onClick={handleSaveVideos} className="bg-green-500 hover:bg-green-600">
